 ...
 * accessibili, che ha il grado di accessibilità  più basso. Così il programma muoverà il cavallo in quella casella, che verrà marchiata con il valore
 * 1, il numero che contraddistingue le caselle visitate da quelle ancora da visitare. 
 * 
 * Ho notato, però, che con questo metodo solo 3 esecuzioni su 10 completavano il giro del cavallo. Ho dovuto quindi mettere dei valori di accessibilità 
 * falsi ad alcune delle caselle centrali. Così facendo, sono arrivato a ottenere il 70% di possibilità di successo del programma.
 *
 *
 *
 *          V 3.2.0                       10/07/2014
